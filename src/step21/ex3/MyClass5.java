...
//        어느 것을 상속해야 할 지 결정할 수 없기 떄문 이다.
// => 그러나 인터페이스는 구현된 메서드가 아니기 떄무네,
//    추상 메서드이기 때문에 여러 인터페이서에 동일한 메서드가 있더라도 
//    상관없다.
public class MyClass5 implements MyInterface3, MyInterface4 {
  ...
  public void m3() {} // m3()가 어느 인터페이스의 메서드인지 굳이 따질 필요가 없다.
                      // 왜? 규칙이기 떄문에 인터페이스 구현 조건을 만족시키기만 하면 된다.
                      // 즉 MyInterface3 입장에서 m1(), m2(), m3()를 모두 구현하였고,
                      // MyInterface4 입장에서도 m3(), m4를 모두 구현한 것이기 때문이다.
  public void m4() {}
