 ...
 *    로딩한 후 그 클래스 정보를 다룰 수 있는 객체를 리턴한다.
 */
package step24;
...
public class ClassTest02 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //    "?"의미? Class 도구가 다룰 수 있는 클래스는 아무거나 가능하다는 의미이다.
    ...
    // 예) step24.ClassTest.MyClass
    //Class<?> c4 = Class.forName("step24.ClassTest01.MyClass");  // 실행 오류!
  }
}
