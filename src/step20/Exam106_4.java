 ...
 * - 부모 스레드: 스레드를 생성한 스레드.
 * - 자식 스레드의 우선 순위는 부모 스레드의 우선 순위를 가져온다.
 */
package step20;
...
public class Exam106_4 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    parentThread.setPriority(8);    // 자식 스레드는 기본적으로 부모 스레드의 우선 순위를 가져온다.
    ...
    childThread.setPriority(3);    // 물론 자식 스레드는 부모와 다른 우선 순위를 가질 수있다.
    System.out.printf("%s(%d), %d\n", childThread.getName(), childThread.getId(), childThread.getPriority());
  } //main()
}