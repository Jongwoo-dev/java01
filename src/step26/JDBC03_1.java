...
public class JDBC03_1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (
      ...
      // update ex_contacts set tel='111-1111', posi='대리' where email='ok@test.com'
      int count = stmt.executeUpdate("update ex_contacts set"
          + " tel='" + tel
          + "', posi='" + position
          + "' where email='" + email
          + "'");
